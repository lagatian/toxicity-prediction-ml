...
- Apply SMOTE to synthetically balance the dataset
- Collect more labelled molecular data
- Incorporate Morgan fingerprints and MACCS structural keys
- Explore Graph Neural Networks for molecular data
- Perform hyperparameter tuning with GridSearchCV
- Apply Recursive Feature Elimination (RFE)
- Validate on external datasets for true generalisation
